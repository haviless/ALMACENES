object FTraslados: TFTraslados
  ...
  object Panel1: TPanel
    ...
    object fcLabel1: TfcLabel
      ...
      Width = 321
      Height = 32
      Caption = 'Traslados de Activo Fijo'
  ...
  object dbgGuia: TwwDBGrid
    ...
    Selected.Strings = (
      'NUMDOC'#9'7'#9'Traslado'
      'FECTRAS'#9'10'#9'Fecha~Traslado'
      'MOTIVO'#9'14'#9'Motivo'
      'OBSERVAC'#9'50'#9'Observaciones'
      'ACEPTADO'#9'07'#9'Aceptado'
      'USUARIO'#9'11'#9'Usuario')
